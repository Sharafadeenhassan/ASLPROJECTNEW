report 50236 "Shop Sales By Device/Location"
{
    ApplicationArea = All;
    Caption = 'Shop Sales By Device/Location ()';
    RDLCLayout = './src/reportrdlc/SalesByDeviceLocation.rdl';
...
var  PayMode : Record "Shop Payment Mode";
