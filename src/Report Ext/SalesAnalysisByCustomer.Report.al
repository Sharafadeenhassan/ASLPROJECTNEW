report 50191 "Sales Analysis By Customer"
{
    ApplicationArea = All;
    Caption = 'Sales Analysis By Customer';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './src/reportrdlc/MyRDLReport.rdl';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            RequestFilterFields = "No.","Date Filter","Global Dimension 1 Filter","Global Dimension 2 Filter","Location Code";
            ...
            dataitem(CustLedger; "Cust. Ledger Entry")
            {
                ...
                dataitem(DetCustLedger; "Detailed Cust. Ledg. Entry")
                {
                    ...
                    DataItemLink = "Cust. Ledger Entry No." = field("Entry No."), "Customer No." = field("Customer No."),
                                ...
                                "Initial Entry Global Dim. 1"= field("Global Dimension 1 code"),"Initial Entry Global Dim. 2" = field("Global Dimension 2 Code");
