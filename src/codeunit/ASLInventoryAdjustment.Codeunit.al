codeunit 50014 "ASL Inventory Adjustment"
{ 
   Permissions = TableData Item = rm,
       ...
       // ItemLedgEntry.SetFilter("Entry Type",'<>%1',ItemLedgEntry."Entry Type"::Transfer);
        ...
        with ItemLedgEntry do
             if AppliedEntryToAdjustExists(Item."No.") then begin
                ...
                repeat
                     if TempItemLedgEntry."Item No." = SkipItem then
                        exit;
    ...
    begin
        with OrigValueEntry do begin
            ...
            IF "Item Ledger Entry Type" = "Item Ledger Entry Type"::Output then              ItemJnlLine."Output Quantity (Base)" := ItemJnlLine."Quantity (Base)";
