...
permissionset 50001 GeneratedPermission
{
    ...
    Permissions = tabledata "AGO Table" = RIMD,
        ...
        report "Store Materia Requisition" = X,
        ...
        page "Inventory Posting Group Detail" = X,
        ...
        page "Purch Request Mgr Action Sheet" = X,
        ...
        page "Purchase Request Sec. check" = X,
        page "Purchase Request Sec. Return" = X,
        ...
        page "Purchase Request QCC List" = X,
